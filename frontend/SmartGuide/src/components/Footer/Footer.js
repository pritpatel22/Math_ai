...
const Footer = () => {
        ...
        <div className="footer-content">
          <div className="footer-content-column">
            <div className="footer-logo">
              <a className="footer-logo-link" href="/home">
                <span className="hidden-link-text">SG</span>
                <h1>SG</h1>
              </a>
            </div>
            ...
            <div className="footer-menu">
              ...
              <ul id="menu-quick-links" className="footer-menu-list">
                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                  <a target="_blank" rel="noopener noreferrer" href="/home">Support Center</a>
                </li>
                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                  <a target="_blank" rel="noopener noreferrer" href="/home">Service Status</a>
                </li>
                <li className="menu-item menu-item-type-post_type menu-item-object-page">
          ...
          <div className="footer-content-column">
            <div className="footer-call-to-action">
              ...
              <a className="footer-call-to-action-button button" href="/home" target="_self">Get in Touch</a>
            </div>
            <div className="footer-call-to-action">
              <h2 className="footer-call-to-action-title">You Call Us</h2>
              <p className="footer-call-to-action-link-wrapper">
                <a className="footer-call-to-action-link" href="tel:0124-64XXXX" target="_self">9638767790</a>
              </p>
            </div>
          </div>
  ...
  <a className="footer-social-link linkedin" href="/home" target="_blank">
  ...
  <a className="footer-social-link youtube" href="/home" target="_blank">
  ...
  <a className="footer-social-link twitter" href="/home" target="_blank">
  ...
  <a className="footer-social-link github" href="/home" target="_blank">
